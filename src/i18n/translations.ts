...
const en = {
  ...
  'onboarding.s1.eyebrow': 'SPACE SITUATIONAL AWARENESS',
  'onboarding.s1.title': 'Orbital\nGuardian',
  'onboarding.s1.body': 'Real-time monitoring of satellites and orbital debris in the near-Earth orbital environment.',
  'onboarding.s2.eyebrow': '3D GLOBE VISUALIZATION',
  'onboarding.s2.title': 'Live Orbital\nTracking',
  'onboarding.s2.chip1': '26+ tracked orbital objects',
  'onboarding.s2.chip2': 'Real-time SGP4 propagation',
  'onboarding.s2.chip3': 'Interactive 3D globe',
  'onboarding.s3.eyebrow': 'COLLISION AVOIDANCE',
  'onboarding.s3.title': 'Conjunction\nAlert System',
  'onboarding.s3.chip1': 'Proximity risk detection',
  'onboarding.s3.chip2': 'Miss distance & Pc calculation',
  'onboarding.s3.chip3': 'Orbital correction support',
...
const pt: typeof en = {
  ...
  'onboarding.s1.eyebrow': 'CONSCIÊNCIA SITUACIONAL ESPACIAL',
  'onboarding.s1.title': 'Orbital\nGuardian',
  'onboarding.s1.body': 'Monitoramento em tempo real de satélites e detritos orbitais no ambiente orbital próximo à Terra.',
  'onboarding.s2.eyebrow': 'VISUALIZAÇÃO 3D DO GLOBO',
  'onboarding.s2.title': 'Rastreamento\nOrbital Ao Vivo',
  'onboarding.s2.chip1': '26+ objetos orbitais rastreados',
  'onboarding.s2.chip2': 'Propagação SGP4 em tempo real',
  'onboarding.s2.chip3': 'Globo 3D interativo',
  'onboarding.s3.eyebrow': 'PREVENÇÃO DE COLISÕES',
  'onboarding.s3.title': 'Sistema de\nAlertas de Conjunção',
  'onboarding.s3.chip1': 'Detecção de risco de proximidade',
  'onboarding.s3.chip2': 'Cálculo de Miss Distance e Pc',
  'onboarding.s3.chip3': 'Suporte a correção orbital',
